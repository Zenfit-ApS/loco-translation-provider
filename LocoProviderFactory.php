...
final class LocoProviderFactory extends AbstractProviderFactory
{
    ...
    public function __construct(HttpClientInterface $client, LoggerInterface $logger, string $defaultLocale, LoaderInterface $loader, TranslatorBagInterface $translatorBag = null, array $domains = [])
    {
    ...
    public function create(Dsn $dsn): LocoProvider
    {
        ...
        return new LocoProvider($client, $this->loader, $this->logger, $this->defaultLocale, $endpoint, $this->domains, $this->translatorBag);
    }
